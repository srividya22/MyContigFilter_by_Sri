...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MyContigFilter_by_Sri'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from MyContigFilter_by_Sri.MyContigFilter_by_SriImpl import MyContigFilter_by_Sri
impl_MyContigFilter_by_Sri = MyContigFilter_by_Sri(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['MyContigFilter_by_Sri.filter_contigs_async'] = ['MyContigFilter_by_Sri', 'filter_contigs']
async_check_methods['MyContigFilter_by_Sri.filter_contigs_check'] = ['MyContigFilter_by_Sri', 'filter_contigs']
sync_methods['MyContigFilter_by_Sri.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'MyContigFilter_by_Sri'
        ...
        self.rpc_service.add(impl_MyContigFilter_by_Sri.filter_contigs,
                             name='MyContigFilter_by_Sri.filter_contigs',
                             types=[dict])
        self.method_authentication['MyContigFilter_by_Sri.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "MyContigFilter_by_Sri but no authentication header was passed"
                            raise err
